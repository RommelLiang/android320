...
public class MineFragment extends BaseFragment implements View.OnClickListener {
	...
	public static final String TAG_GetShaitu = "TAG_GetShaitu";
	private boolean mIsVersion;
	private ImageView im_background;
	private TextView tv_shai_tu_is_show;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tv_shai_tu_is_show = (TextView) view.findViewById(R.id.tv_shai_tu_is_show);
		...
		if (SPUtils.getIsNewShatiu()){
			tv_shai_tu_is_show.setVisibility(View.VISIBLE);
		} else {
			tv_shai_tu_is_show.setVisibility(View.GONE);
		}
...
//                .GET_PASSKEY()), callBack, "获取passkey", false));
	...
	private void successParse(String msg, String resultTag) {
		if (resultTag.equals(HttpTools.TAG_AULOGIN)) {
			...
			NewShaituBean newShaituBean = GsonUtils.fromData(msg, NewShaituBean.class);
			...
			if (newShaituBean != null) {
				...
				if (openShaituTime.equals("")) {
					openShaituTime = SPUtils.getAddTime();
				}
