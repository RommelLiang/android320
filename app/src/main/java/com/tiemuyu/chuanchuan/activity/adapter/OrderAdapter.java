...
import com.tiemuyu.chuanchuan.activity.PayMentActivity;
import com.tiemuyu.chuanchuan.activity.PaySelect;
import com.tiemuyu.chuanchuan.activity.R;
import com.tiemuyu.chuanchuan.activity.SetPayPasswordActivity;
...
public class OrderAdapter extends BaseAdapter implements NetResponses, ThreadPoolTaskHttp.HttpCallBack {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_price.setText("￥" + rowsAll.get(position).getItems().get(0).getPrice() + "");
            ...
            holder.tv_total_price.setText(
                    Html.fromHtml(
                            "合计:" + "<font color=\"#450525\"><b>￥" +
                                    rowsAll.get(position).getActualFee() + "</b></font>" + " " +
        ...
        switch (rowsAll.get(position).getStatus()) {
            case 11:
                ...
                break;
            case 12:
                if (rowsAll.get(position).getIsAllowRefund() == 1) {
