...
//{"Code":1,"Msg":"OK","Data":{"PayMomeny":100.0,"OrderId":9850}}
	 ...
	 * Author：rommel
	 * @param: userid 用户id
	 * @param: datetime app安装时间
	 * @param: startpos 分页起始位置
	 * @param: itemcount 分页一页的数据条目
	 * @return: String url
	 * Desc：获取推送历史记录
	 */
	public static final String getPush(String userid, String datetime, String startpos, int itemcount) {
		return "http://imserver.myappcc.com/api/UMeng?datetime=" + datetime
				+"&userid=" + userid
				+"&startpos=" + startpos
				+"&itemcount="+itemcount
				+"&rule=desc";
