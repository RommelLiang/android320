package com.tiemuyu.chuanchuan.activity.share_auth;
...
import com.tiemuyu.chuanchuan.activity.model.Defaultcontent;
...
/**
 * @项目名： android1017
 * @包名： com.tiemuyu.chuanchuan.activity.share_auth
 * @类描述：
 * @创建人： hr
 * @创建时间： 2016/10/18
 * @version：
...
public class ShareMenuActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // umeng authorization:
        UMShareAPI  mShareAPI = UMShareAPI.get( ShareMenuActivity.this );
        mShareAPI.doOauthVerify(ShareMenuActivity.this, SHARE_MEDIA.WEIXIN, umAuthListener);
        mShareAPI.doOauthVerify(ShareMenuActivity.this, SHARE_MEDIA.WEIXIN_CIRCLE, umAuthListener);
        mShareAPI.doOauthVerify(ShareMenuActivity.this, SHARE_MEDIA.WEIXIN_FAVORITE, umAuthListener);
        mShareAPI.doOauthVerify(ShareMenuActivity.this, SHARE_MEDIA.SINA, umAuthListener);
        initPlatforms();
...
//            }
//        }
        //System.out.println(SHARE_MEDIA.WEIXIN_CIRCLE.toSnsPlatform());
        ...
        public void onclick(SnsPlatform snsPlatform,SHARE_MEDIA share_media) {
            if (share_media==null){
                if (snsPlatform.mKeyword.equals("umeng_sharebutton_custom")){
                    Toast.makeText(ShareMenuActivity.this,"add button success",Toast.LENGTH_LONG).show();
                }

            }
            else {
                new ShareAction(ShareMenuActivity.this).setPlatform(share_media).setCallback(umShareListener)
                        .withText("多平台分享")
                        .share();
            }
        }
