...
public class MessageAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        messageShowUtil.setCheckMessageShowType(viewHolder, showType, data.get(position), views);

        if (!"".equals(MessageActivity.HEADER_URL))
            imageLoader.displayImage(MessageActivity.HEADER_URL, viewHolder.message_portrait_left);
        if (!"".equals(MainActivity.OWN_HEADER_URL))
            imageLoader.displayImage(MainActivity.OWN_HEADER_URL, viewHolder.message_portrait_right);
