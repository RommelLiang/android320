...
public class RoundProgressBar extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		if(textIsDisplayable && percent != 0 && style == STROKE){
			canvas.drawText(time + "", centre-textSize/4, centre + textSize/2 -20, paint); //画出进度百分比
			canvas.drawText("跳过", centre - textWidth / 2, centre + textSize/2 + 20, paint); //画出进度百分比
		}
